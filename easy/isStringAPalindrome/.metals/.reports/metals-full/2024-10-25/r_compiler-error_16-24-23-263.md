...
### file%3A%2F%2F%2Fhome%2Fr00t%2Fcode%2Fleetcode_solutions%2Feasy%2FisStringAPalindrome%2Fsrc%2Fmain%2Fscala%2Fexample%2FSolution.scala:31: error: unclosed string literal
...
object Solution {
    def isPalindrome(input: String): Boolean = {
        ...
        else if(input.size == 2) checkCharacters(0, 1) // base case?
