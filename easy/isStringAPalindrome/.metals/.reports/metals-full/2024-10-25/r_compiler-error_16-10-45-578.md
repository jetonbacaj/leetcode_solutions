...
### file%3A%2F%2F%2Fhome%2Fr00t%2Fcode%2Fleetcode_solutions%2Feasy%2FisStringAPalindrome%2Fsrc%2Fmain%2Fscala%2Fexample%2FSolution.scala:6: error: `identifier` expected but `def` found
...
object Solution {
    def isPalindrome(input: String): Boolean = {
        ...
        def checkCharacters(idx1: Int, idx2: Int): Boolean = {
            ...
            if(input.charAt(idx1) == input.charAt(idx2)) checkCharacters(idx1-1, idx2+1)
...
scala.meta.internal.parsers.Reporter.syntaxError(Reporter.scala:16)
	...
	scala.meta.internal.parsers.ScalametaParser.exprSimpleType(ScalametaParser.scala:2738)
	scala.meta.internal.parsers.ScalametaParser.$anonfun$annotsBuf$2(ScalametaParser.scala:2909)
	...
	scala.meta.internal.parsers.ScalametaParser.$anonfun$annotsBuf$1(ScalametaParser.scala:2909)
	scala.meta.internal.parsers.ScalametaParser.autoEndPos(ScalametaParser.scala:372)
	scala.meta.internal.parsers.ScalametaParser.annotsBuf(ScalametaParser.scala:2909)
	scala.meta.internal.parsers.ScalametaParser.$anonfun$localDef$1(ScalametaParser.scala:4181)
	scala.meta.internal.parsers.ScalametaParser.$anonfun$localDef$1$adapted(ScalametaParser.scala:4180)
	scala.meta.internal.parsers.ScalametaParser.scala$meta$internal$parsers$ScalametaParser$$listBy(ScalametaParser.scala:562)
	scala.meta.internal.parsers.ScalametaParser.localDef(ScalametaParser.scala:4180)
