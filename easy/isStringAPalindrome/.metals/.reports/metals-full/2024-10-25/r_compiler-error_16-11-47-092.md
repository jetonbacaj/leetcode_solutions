...
### file%3A%2F%2F%2Fhome%2Fr00t%2Fcode%2Fleetcode_solutions%2Feasy%2FisStringAPalindrome%2Fsrc%2Fmain%2Fscala%2Fexample%2FSolution.scala:14: error: `)` expected but `=` found
        if(input.size % 2 = )
                          ^
