...
### file%3A%2F%2F%2Fhome%2Fr00t%2Fcode%2Fleetcode_solutions%2Fhard%2FmedianFromDataStream%2Fsrc%2Fmain%2Fscala%2Fexample%2FSolution.scala:36: error: `identifier` expected but `if` found
            if(arraySize == 1) pq.dequeue().doubleValue()
            ^
