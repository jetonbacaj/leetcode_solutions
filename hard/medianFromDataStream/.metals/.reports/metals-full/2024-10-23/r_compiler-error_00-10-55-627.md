...
### file%3A%2F%2F%2Fhome%2Fr00t%2Fcode%2Fleetcode_solutions%2Fhard%2FmedianFromDataStream%2Fsrc%2Fmain%2Fscala%2Fexample%2FSolution.scala:27: error: `}` expected but `)` found
                (arr(arr.length-1)/2) + arr(arr.length/2)).doubleValue() / 2
                                                         ^
